...
const Healthcare = () => {
    ...
    const contractAddress = "0x4adb90f17b834733c623c09333b631b86943fb79";
    ...
    return(
        <div className='container'>
            <h1 className = "title">LG Healthcare</h1>
            {account && <p className='account-info'>Account: {account}</p>}
            {isOwner && <p className='owner-info'>OWNER</p>}

        <div className='form-section'>
            <h2>Locate Patient Records</h2>
            ...
            <button className='action-button' onClick={fetchPatientRecords}>Find Records</button>
        </div>
        ...
        <div className="form-section">
            ...
            <button className='action-button' onClick={authorizeProvider}>Add Provider</button>
        </div>
        ...
        <div className='records-section'>
            ...
            {patientRecords.map((record, index) => (
                <div key = {index}>
                    ...
                    <p>Date/Time {new Date(record.timestamp.toNumber() * 1000).toLocaleString()}</p>
            </div>
            ))}
        </div>
